...
public class DataManagerTest {
    ...
    public void createNewNote() {
        ...
        final String noteText = "The text for the note test..";
    ...
    public void findSimilarNotes() throws Exception{
        final CourseInfo course = sDataManager.getCourse("android_async");
        final String noteTitle = "Test note title";
        final String noteText1 = "The text for the note test..";
        final String noteText2 = "The text 2 for the note test..";
    ...
    @Test
    public void createNewNoteOneStep() throws Exception{
        final CourseInfo course = sDataManager.getCourse("android_async");
        final String noteTitle = "Test note title";
        final String noteText = "The text for the note test..";
